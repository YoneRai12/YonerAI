...
def build_hybrid_node_relay_contract_stub(env: Mapping[str, str] | None = None) -> dict[str, object]:
    ...
    return {
        ...
        "local_dev_e2e": {
            ...
            "transport_schema_version": _section_value(e2e_status, "transport", "schema_version"),
            "transport_mode": _section_value(e2e_status, "transport", "mode"),
            "transport_loopback_only": _section_value(e2e_status, "transport", "loopback_only"),
