...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1355-1365 | `ORACog._send_large_message.large_message_chunking` | Split a Discord-bound response into 1900-character chunks while keeping the first chunk tied to the reply. | none | low | yes | `src/cogs/ora_message_format_helpers.py` | characterization parity before wrapper extraction |
| 1418-1418 | `ORACog._perform_guardrail_check.guardrail_response_interpretation` | Delegate guardrail model response interpretation to the extracted pure helper. | none | low | no | `src/cogs/ora_guardrail_helpers.py` | wrapper compatibility test |

## Definition Map

| Lines | Qualname | Responsibility | Side effects | Risk | Candidate | Target | Required tests |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 90-92 | `_nonce` | Legacy helper or setup block. | none | low | no |  | static map coverage only |
| 98-125 | `_generate_tree` | Legacy helper with file boundary involvement. | file | high | no |  | workspace/temp-file allowlist test |
| 131-3082 | `ORACog` | ORA-specific commands such as login link and dataset management. | discord, provider_or_llm, memory, file, tool_or_shell_policy, network, system_or_process | high | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test; workspace/temp-file allowlist test; deny-by-default tool boundary test; network-disabled fixture test; read-only diagnostic fixture test |
| 134-220 | `ORACog.__init__` | Initializes ORACog runtime dependencies and mutable state. | discord, provider_or_llm, memory, file, tool_or_shell_policy, network, system_or_process | high | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test; workspace/temp-file allowlist test; deny-by-default tool boundary test; network-disabled fixture test; read-only diagnostic fixture test |
| 222-231 | `ORACog._load_soul` | Load the 'Soul' (Persona) prompt from data/soul.md. | file | high | no |  | workspace/temp-file allowlist test |
| 239-245 | `ORACog.set_status` | Helper to set bot status from callbacks. | discord | medium | no |  | discord-free static or mock interaction test |
| 261-346 | `ORACog.dashboard` | Get the link to this server's web dashboard. | discord, network, system_or_process | high | no |  | discord-free static or mock interaction test; network-disabled fixture test; read-only diagnostic fixture test |
| 348-359 | `ORACog.cog_load` | Called when the Cog is loaded. Performs Startup Sync. | none | low | no |  | static map coverage only |
| 361-386 | `ORACog._startup_sync` | Syncs OpenAI usage and updates local limiter state. | provider_or_llm, network | high | no |  | provider mocked or local-fixture execution test; network-disabled fixture test |
| 388-404 | `ORACog.cog_unload` | Legacy helper or setup block. | none | low | no |  | static map coverage only |
| 407-514 | `ORACog.check_unoptimized_users` | Periodically scan for unoptimized users and trigger optimization. | discord, file | high | no |  | discord-free static or mock interaction test; workspace/temp-file allowlist test |
| 516-524 | `ORACog._on_game_start` | Callback when game starts: Switch to Gaming Mode IMMEDIATELY. | none | low | no |  | static map coverage only |
| 526-531 | `ORACog._on_game_end` | Callback when game ends: Schedule switch to Normal Mode after 5 minutes. | none | low | no |  | static map coverage only |
| 533-543 | `ORACog._restore_normal_mode_delayed` | Wait 5 minutes then restore Normal Mode. | none | low | no |  | static map coverage only |
| 553-586 | `ORACog._check_permission` | Check if user has permission. Levels: - 'owner': Only the Bot Owner (Config Admin ID). - 'sub_admin': Owner OR Sub-Admins. - 'vc_admin': Owner OR Sub-Admins OR VC Admins. | none | low | no |  | static map coverage only |
| 589-604 | `ORACog.hourly_sync_loop` | Periodically sync OpenAI usage with official API. | discord, network | high | no |  | discord-free static or mock interaction test; network-disabled fixture test |
| 607-697 | `ORACog.desktop_loop` | Periodically check the desktop and report to Admin. | discord | medium | no |  | discord-free static or mock interaction test |
| 714-749 | `ORACog.system_reload` | Reloads an extension without restarting the bot. | discord, system_or_process | high | no |  | discord-free static or mock interaction test; read-only diagnostic fixture test |
| 759-765 | `ORACog.desktop_watch` | Toggle desktop watcher. | discord | medium | no |  | discord-free static or mock interaction test |
| 769-788 | `ORACog.system_info` | Show system info. | discord, system_or_process | high | no |  | discord-free static or mock interaction test; read-only diagnostic fixture test |
| 791-807 | `ORACog.system_process_list` | List top processes. | discord, system_or_process | high | no |  | discord-free static or mock interaction test; read-only diagnostic fixture test |
| 810-811 | `ORACog.before_desktop_loop` | Discord command/listener/task entrypoint. | none | medium | no |  | static map coverage only |
| 813-829 | `ORACog.login` | Discord command/listener/task entrypoint. | discord, network | high | no |  | discord-free static or mock interaction test; network-disabled fixture test |
| 831-834 | `ORACog._ephemeral_for` | Return True if the user's privacy setting is 'private'. | discord | medium | no |  | discord-free static or mock interaction test |
| 837-846 | `ORACog.whoami` | Discord command/listener/task entrypoint. | discord | medium | no |  | discord-free static or mock interaction test |
| 856-863 | `ORACog.ora_privacy` | Discord command/listener/task entrypoint. | discord | medium | no |  | discord-free static or mock interaction test |
| 873-878 | `ORACog.privacy_set_system` | Discord command/listener/task entrypoint. | discord | medium | no |  | discord-free static or mock interaction test |
| 880-906 | `ORACog.chat` | Legacy helper with discord, provider_or_llm boundary involvement. | discord, provider_or_llm | medium | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test |
| 916-968 | `ORACog.dataset_add` | Discord command/listener/task entrypoint. | discord, file, network | high | no |  | discord-free static or mock interaction test; workspace/temp-file allowlist test; network-disabled fixture test |
| 971-980 | `ORACog.dataset_list` | Discord command/listener/task entrypoint. | discord | medium | no |  | discord-free static or mock interaction test |
| 987-1033 | `ORACog.summarize` | Summarize recent chat history. | discord, provider_or_llm | medium | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test |
| 1047-1067 | `ORACog.status` | Discord command/listener/task entrypoint. | discord | medium | no |  | discord-free static or mock interaction test |
| 1075-1078 | `ORACog.memory_clear` | Discord command/listener/task entrypoint. | discord, memory | medium | no |  | discord-free static or mock interaction test |
| 1082-1130 | `ORACog.test_all` | Run a full system diagnostic check. | discord, provider_or_llm | medium | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test |
| 1132-1149 | `ORACog._get_voice_channel_info` | Legacy helper with discord boundary involvement. | discord | medium | no |  | discord-free static or mock interaction test |
| 1156-1184 | `ORACog.process_message_queue` | Process queued messages after image generation completes. | discord | medium | no |  | discord-free static or mock interaction test |
| 1187-1218 | `ORACog.switch_brain` | Switch the AI Brain Mode. | discord | medium | no |  | discord-free static or mock interaction test |
| 1222-1280 | `ORACog.system_override` | Override System Limits (Roleplay). | discord | medium | no |  | discord-free static or mock interaction test |
| 1283-1341 | `ORACog.check_credits` | Check usage stats using CostManager with Sync. | discord, provider_or_llm | medium | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test |
| 1343-1367 | `ORACog._send_large_message` | Splits and sends large messages to avoid 400 Bad Request. | discord | medium | no |  | discord-free static or mock interaction test |
| 1369-1371 | `ORACog._detect_spam` | Compatibility wrapper for the extracted ORA spam detector. | none | low | yes | `src/cogs/ora_pure_helpers.py` | characterization parity before wrapper extraction |
| 1373-1375 | `ORACog._is_input_spam` | Compatibility wrapper for the extracted ORA input spam detector. | none | low | yes | `src/cogs/ora_pure_helpers.py` | characterization parity before wrapper extraction |
| 1377-1424 | `ORACog._perform_guardrail_check` | [Layer 2 Security] AI Guardrail. Uses a cheap model (gpt-5-mini) to check for loop/spam/jailbreak instructions that regex missed. | provider_or_llm | medium | no |  | provider mocked or local-fixture execution test |
| 1426-1428 | `ORACog._extract_json_objects` | Compatibility wrapper for the extracted ORA JSON recovery helper. | none | low | yes | `src/cogs/ora_pure_helpers.py` | characterization parity before wrapper extraction |
| 1430-1432 | `ORACog._clean_content` | Remove internal tags like <\|channel\|>... from the text. | none | low | yes | `src/cogs/ora_pure_helpers.py` | characterization parity before wrapper extraction |
| 1435-1725 | `ORACog.on_message` | Discord command/listener/task entrypoint. | discord, provider_or_llm, file, tool_or_shell_policy | high | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test; workspace/temp-file allowlist test; deny-by-default tool boundary test |
| 1728-1754 | `ORACog._process_attachments` | Process a list of attachments (Text or Image) and update prompt/context. | discord, file | high | no |  | discord-free static or mock interaction test; workspace/temp-file allowlist test |
| 1756-1770 | `ORACog._process_embed_images` | Process images found in Embeds (Thumbnail or Image field). | discord | medium | no |  | discord-free static or mock interaction test |
| 1772-2881 | `ORACog._get_tool_schemas` | Returns the list of available tools, organized by Category. Includes 'tags' for RAG filtering. | none | low | no |  | static map coverage only |
| 2883-2912 | `ORACog.get_context_tools` | Public method to get tools filtered by client context. Prevents usage of Discord-only tools in Web UI, or Web tools in Discord. Also includes Dynamically Loaded Skills from SKILL.m | tool_or_shell_policy | high | no |  | deny-by-default tool boundary test |
| 2915-2924 | `ORACog.handle_prompt` | Process a user message and generate a response using the LLM (Delegated to ChatHandler). | discord, provider_or_llm | medium | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test |
| 2926-2928 | `ORACog._legacy_handle_prompt` | Legacy helper or setup block. | none | low | no |  | static map coverage only |
| 2929-2942 | `ORACog.wait_for_llm` | Show a loading animation while waiting for LLM. | discord | medium | no |  | discord-free static or mock interaction test |
| 2944-2966 | `ORACog._create_mock_interaction` | Helper to create a mock interaction from context. | discord | medium | no |  | discord-free static or mock interaction test |
| 2946-2964 | `ORACog._create_mock_interaction.MockInteraction` | Legacy helper with discord boundary involvement. | discord | medium | no |  | discord-free static or mock interaction test |
| 2947-2952 | `ORACog._create_mock_interaction.MockInteraction.__init__` | Initializes ORACog runtime dependencies and mutable state. | discord | medium | no |  | discord-free static or mock interaction test |
| 2954-2959 | `ORACog._create_mock_interaction.MockInteraction.Response` | Legacy helper with discord boundary involvement. | discord | medium | no |  | discord-free static or mock interaction test |
| 2955-2955 | `ORACog._create_mock_interaction.MockInteraction.Response.__init__` | Initializes ORACog runtime dependencies and mutable state. | none | low | no |  | static map coverage only |
| 2956-2956 | `ORACog._create_mock_interaction.MockInteraction.Response.is_done` | Legacy helper or setup block. | none | low | no |  | static map coverage only |
| 2957-2958 | `ORACog._create_mock_interaction.MockInteraction.Response.send_message` | Legacy helper with discord boundary involvement. | discord | medium | no |  | discord-free static or mock interaction test |
| 2959-2959 | `ORACog._create_mock_interaction.MockInteraction.Response.defer` | Legacy helper or setup block. | none | low | no |  | static map coverage only |
| 2961-2964 | `ORACog._create_mock_interaction.MockInteraction.Followup` | Legacy helper with discord boundary involvement. | discord | medium | no |  | discord-free static or mock interaction test |
| 2962-2962 | `ORACog._create_mock_interaction.MockInteraction.Followup.__init__` | Initializes ORACog runtime dependencies and mutable state. | none | low | no |  | static map coverage only |
| 2963-2964 | `ORACog._create_mock_interaction.MockInteraction.Followup.send` | Legacy helper with discord boundary involvement. | discord | medium | no |  | discord-free static or mock interaction test |
| 2969-3037 | `ORACog.on_raw_reaction_add` | Handle flag reactions for translation. | discord, provider_or_llm | medium | no |  | discord-free static or mock interaction test; provider mocked or local-fixture execution test |
| 3040-3065 | `ORACog.rank` | Check your current points and rank. | discord | medium | no |  | discord-free static or mock interaction test |
