...
export default function DashboardPage() {
    ...
    if (!mounted || loading) {
        return (
            <div className="min-h-screen bg-neutral-950 flex items-center justify-center text-neutral-500 font-mono" suppressHydrationWarning>
                <Loader2 className="w-8 h-8 animate-spin mr-3" suppressHydrationWarning />
