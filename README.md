...
This project is licensed under **CC BY-NC-ND 4.0**. See `LICENSE`.

Important: this license allows sharing with attribution, but prohibits commercial use and distribution of derivatives.
