...
[Japanese README](README_JP.md) | [Current phase](docs/CURRENT_PHASE_CONTEXT.md) | [Contracts](docs/contracts) | [Latest checkpoint](docs/releases/v2026.5.20.14-tools-mcp-safe-subset-contract-checkpoint.md)
...
The current public checkpoint stream uses the verified 2026-05-20 date with same-day suffixes. `v2026.5.20.14` records the Tools/MCP safe subset contract for this lane. It is a checkpoint note, not a production release.
