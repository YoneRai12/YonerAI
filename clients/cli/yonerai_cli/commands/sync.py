...
def format_sync_pretty_v2(report: dict[str, Any], *, lang: str = "ja", color: ColorMode = "auto") -> str:
    ...
    for key in (
        ...
        "firebase_custom_token_exchange_attempted",
        "firebase_custom_token_exchange_passed",
        "firebase_id_token_received",
        "firebase_id_token_printed",
        "firebase_id_token_persisted",
        "firebase_refresh_token_discarded",
        "firebase_refresh_token_persisted",
        "firebase_token_type",
