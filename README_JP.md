...
現在の public checkpoint stream は、検証済みの 2026-05-20 日付と同日 suffix を使います。`v2026.5.20.6` は、この lane の hybrid envelope policy semantics fix を記録する checkpoint note です。production release ではありません。
