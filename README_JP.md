...
[English README](README.md) | [Current phase](docs/CURRENT_PHASE_CONTEXT.md) | [Contracts](docs/contracts) | [Latest checkpoint](docs/releases/v2026.5.20-public-core-message-mvp-checkpoint.md)
...
`v2026.5.20` は public core message MVP checkpoint であり、production release ではありません。
...
現在の public MVP は、secret なしで動く local Core API の health smoke と、mock/offline message contract です。ChatGPT のような Web chat product ではありません。
...
まだ含まれていないもの: Web UI chat、Google login、conversation history sync、persistent natural memory、web search、Discord chat、provider live generation、official cloud、deployment、full product completion。
...
- [v2026.5.20 checkpoint note](docs/releases/v2026.5.20-public-core-message-mvp-checkpoint.md)
