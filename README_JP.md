...
[English README](README.md) | [Current phase](docs/CURRENT_PHASE_CONTEXT.md) | [Contracts](docs/contracts) | [Latest checkpoint](docs/releases/v2026.5.20.14-tools-mcp-safe-subset-contract-checkpoint.md)
...
現在の public checkpoint stream は、検証済みの 2026-05-20 日付と同日 suffix を使います。`v2026.5.20.14` は、この lane の Tools/MCP safe subset contract を記録する checkpoint note です。production release ではありません。
